...
import it.moondroid.chatbot.eliza.about;
            ...
            if (intent.getAction().equalsIgnoreCase(Constants.BROADCAST_ACTION_BRAIN_STATUS)) {
                ...
                switch (status) {
                    ...
                    case Constants.STATUS_BRAIN_LOADING:
                        Toast.makeText(MainActivity.this, "Wait SIA is Loading...", Toast.LENGTH_LONG).show();
                        if (dialog != null) {
                    ...
                    case Constants.STATUS_BRAIN_LOADED:
                        Toast.makeText(MainActivity.this, "SIA is Loaded Now !", Toast.LENGTH_SHORT).show();
                        if (dialog != null) {
                            dialog.setPositiveButtonEnabled(true);
                        }
